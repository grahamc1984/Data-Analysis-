...
In relation to the course progress investigation, I used the "mutate" function to add a numeric column, using 1 and 0, which represented whether the learner had completed a step.  This allowed me to scrutinise the course progress of learners within an archetype.  
...
Similarly, I combined the step.activity data for runs 3-7 using "rbind" and then joined this with the "arch_compl" archetype data.  
