...
``` {r steps 2017, include=FALSE, echo=FALSE}
...
```{r steps 2018, include=FALSE, echo=FALSE}

ggplot(step_by_arch_2018, aes(x = as.factor(archetype), y = `sum(progress)`)) + geom_boxplot()
```
[add explanatory text ]
